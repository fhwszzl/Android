...
public class PhotoWallCheckBoxAdapter extends BaseAdapter {
    ...
    public PhotoWallCheckBoxAdapter(Context context, ArrayList<String> imagePathList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_photo_wall_checkbox, null);
