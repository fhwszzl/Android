 ...
 */
package com.maikefengchao.relybox.Adapter;
...
import com.maikefengchao.relybox.ChatFunctionFragment;
import com.maikefengchao.relybox.FacePageFragment;
import com.maikefengchao.relybox.OnOperationListener;
import com.maikefengchao.relybox.R;
import com.maikefengchao.relybox.emoji.EmojiPageFragment;
import com.maikefengchao.relybox.widget.KJChatKeyboard;
import com.maikefengchao.relybox.widget.PagerSlidingTabStrip;
...
public class FaceCategroyAdapter extends FragmentStatePagerAdapter implements
    ...
    //每个item表示一个folder绝对路径，每个folder中存放的是一套face图片  folder表示底部可选的图片库类型
    ...
    public void setPageIcon(int position, ImageView image) {
        if (position == 0) {
            image.setImageResource(R.mipmap.icon_face_click);
            return;
        }
